...
def test_created_ghostpost(ghost_post):
    ...
    assert ghost_post.image == "/photo_storage/ptah-5.jpg"
...
def test_created_otherpost(other_post):
    ...
    assert other_post.image == "/photo_storage/ptah-6.jpg"
