...
create_ghost = create_post(GhostPostSerializer)
update_ghost = update_post(GhostPost, GhostPostSerializer)
delete_ghost = delete_post(GhostPost)

all_others = get_all_posts(OtherPost, OtherPostSerializer)
user_others = get_user_posts(OtherPost, OtherPostSerializer)
create_other = create_post(OtherPostSerializer)
update_other = update_post(OtherPost, OtherPostSerializer)
delete_other = delete_post(OtherPost)